    ...
    this.stageBuilder = new ChallengeDynamicBuilder({
      ...
      buildChallenge: (stage) => { //Converte as nuvens de um desafio em checkpoints coletáveis
        ...
        if (this.stageBuilder.currentCheckpoints.param1 == false) {
          possibilities.push(() => {
            generateCheckpointValue = (myObj) => {
              checkpointValue = this.stageBuilder.param1Range[randomInt(0, this.stageBuilder.param1Range.length)];
        ...
        if (this.stageBuilder.currentCheckpoints.param2 == false) {
          possibilities.push(() => {
            generateCheckpointValue = (myObj) => {
              checkpointValue = this.stageBuilder.param2Range[randomInt(0, this.stageBuilder.param2Range.length)];
              myObj.properties.checkpointValue = checkpointValue;
            }
          })
        }
