            ...
            if (_this3.stageBuilder.currentCheckpoints.param1 == false) {
              possibilities.push(function () {
                generateCheckpointValue = function generateCheckpointValue(
                  ...
                  checkpointValue =
                    _this3.stageBuilder.param1Range[
                    randomInt(0, _this3.stageBuilder.param1Range.length)
                    ];
            ...
            if (_this3.stageBuilder.currentCheckpoints.param2 == false) {
              possibilities.push(function () {
                generateCheckpointValue = function generateCheckpointValue(
                  ...
                  checkpointValue =
                    _this3.stageBuilder.param2Range[
                    randomInt(0, _this3.stageBuilder.param2Range.length)
                    ];
                  myObj.properties.checkpointValue = checkpointValue;
                };
              });
...
var mayCreateNewEngine = false;
sheetLoader.loadSheetQueue(function () {
  if (debugEngine) console.log("Imagens carregadas!");
  mayCreateNewEngine = true;
  newEngine();
});

var newEngine = function newEngine() {
  if (mayCreateNewEngine == true) {
    if (engine) {
      engine.hasGameloop = false;
      engine = null;
    }

    engine = new GameEngine(canvas.getContext("2d"), canvas);
    engine.start();
  }
};
