...
class GameEngine {
  ...
  firstFrame(stageToLoad = 1) {
    ...
    this.ceu = new BGGradiente([
      {
        ...
        keyframe: 0,
        points: [
          { id: 0, color: { r: 140, g: 148, b: 239 }, position: 0 },
          { id: 1, color: { r: 140, g: 165, b: 239 }, position: 0.33 },
          { id: 2, color: { r: 140, g: 170, b: 239 }, position: 1 },
        ]
      },
      {
        keyframe: 500,
        points: [
          { id: 0, color: { r: 189, g: 170, b: 239 }, position: 0 },
          { id: 1, color: { r: 206, g: 180, b: 239 }, position: 0.33 },
          { id: 2, color: { r: 206, g: 197, b: 239 }, position: 1 },
        ]
      },
      {
        keyframe: 1000,
        points: [
          { id: 0, color: { r: 224, g: 225, b: 220 }, position: 0 },
          { id: 1, color: { r: 239, g: 239, b: 206 }, position: 0.33 },
          { id: 2, color: { r: 239, g: 235, b: 169 }, position: 1 },
        ]
      },
      {
        keyframe: 1300,
        points: [
          { id: 0, color: { r: 239, g: 212, b: 145 }, position: 0 },
          { id: 1, color: { r: 239, g: 191, b: 122 }, position: 0.33 },
          { id: 2, color: { r: 239, g: 182, b: 113 }, position: 1 },
        ]
      },
      {
        keyframe: 2000,
        points: [
          { id: 0, color: { r: 239, g: 154, b: 119 }, position: 0 },
          { id: 1, color: { r: 239, g: 145, b: 130 }, position: 0.33 },
          { id: 2, color: { r: 239, g: 138, b: 144 }, position: 1 },
        ]
      },
    ...
    this.stageBuilder = new ChallengeDynamicBuilder({
      currentSpeed: 1,
      speedStep: 0.15,
      param1Range: [6, 5, 7, 6, 5, 7], // Na fase 3 o barato é louco
      param2Range: [6, 9, 3, 4, 7, 5],
